...
public class ElementConstitutifBusinessTest {
	...
	public void setup() {
		...
		ElementConstitutif ElementConstitutif1 = new ElementConstitutif(new ElementConstitutifPK("codeF","codeUe","CodeUc"), "description", "Toto", a, a,a);
		ElementConstitutif ElementConstitutif2 = new ElementConstitutif(new ElementConstitutifPK("codeF2","codeUe2","CodeUc2"),"description", "Toto2", a, a,a);
	...
	public void creerElementConstitutif() {
		ElementConstitutif elementConstitutif = new ElementConstitutif(new ElementConstitutifPK("codeF3","codeUe3","CodeUc3"), "description","Toto3", a, a,a);
	...
	public void supprimerElementConstitutif() {
		ElementConstitutif elementConstitutif = new ElementConstitutif(new ElementConstitutifPK("codeF7","codeUe7","CodeUc7"), "description","Toto7", a, a,a);
		elementconstitutifBusiness.creerElementConstitutif(elementConstitutif);
